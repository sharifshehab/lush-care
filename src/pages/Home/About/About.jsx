            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center space-y-5 md:space-y-28">
                ...
                <div className="content space-y-8">
                    <div className="space-y-5">
                        <h2 className="text-4xl lg:text-5xl dark:text-white" data-aos="zoom-in" data-aos-duration="3000">
                            Nurturing Lawns,
                        </h2>
                        <h2 className="text-4xl lg:text-5xl text-primaryColor dark:text-white" data-aos="fade-up"
                    ...
                    <div>
                        <div className="space-y-2 font-semibold pb-5 dark:text-white" data-aos="zoom-in">
